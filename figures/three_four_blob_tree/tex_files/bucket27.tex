...
\node[circle,fill=red,inner sep=1.3pt] (root) at (1.83,.58) {};
\node[circle,fill=blue,inner sep=1.3pt] at (1.17,0) {};
\node[circle,fill=blue,inner sep=1.3pt] at (-.5,0) {};
\end{scope}
...
\draw[line width=0.8pt] (u5) -- (D);
\draw[line width=0.8pt] (u6) -- (E);
\node[circle,fill=red,inner sep=1.3pt] (root) at (1.415,.145) {};
\node[circle,fill=blue,inner sep=1.3pt] at (1.17,0) {};
\node[circle,fill=blue,inner sep=1.3pt] at (-.5,0) {};
\end{scope}
...
\draw[line width=0.8pt] (u5) -- (D);
\draw[line width=0.8pt] (u6) -- (E);
\node[circle,fill=red,inner sep=1.3pt] (root) at (1.66,0) {};
\node[circle,fill=blue,inner sep=1.3pt] at (1.17,0) {};
\node[circle,fill=blue,inner sep=1.3pt] at (-.5,0) {};
\end{scope}
